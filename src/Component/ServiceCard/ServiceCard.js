...
template.innerHTML =
  ...
  <div class="p-5">
        ...
        <p id="serivecarddescription" class="mb-3 font-normal text-gray-700 dark:text-gray-400"></p>
        <a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-secondary-default rounded-lg hover:text-primary-default focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            Read more
